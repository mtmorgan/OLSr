---
title: "2. Case Study: CELLxGENE Ontologies"
author:
- name: Martin Morgan
  affiliation: "Roswell Park Comprehensive Cancer Center, Buffalo, NY, US"
output: BiocStyle::html_document
vignette: >
  %\VignetteIndexEntry{2. Case Study: CELLxGENE Ontologies}
...
# Annotating the CELLxGENE 'disease' facet
...
# Carcinoma datasets in CELLxGENE
...
```{r ancestor-graph}
ids <- pull(disease_terms, "obo_id")
disease_graph <- get_ancestors_graph("mondo", ids, mondo)
```
